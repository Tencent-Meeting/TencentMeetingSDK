...
| kTMSDKSceenCastServerOperationLimited               | -5008  | 无线投屏服务操作限频                                      | OnScreenCastResult() 
| kTMSDKSceenCastXmppTimeout                          | -5009  | 投屏码返回超时                                      | OnScreenCastResult() 
| kTMSDKSceenCastNetEstablishingFailed                    | -5010  | 无线投屏网络连接失败                                      | OnScreenCastResult() 
| kTMSDKSceenCastQueryCastCodeServerError                    | -5011  | 获取无线投屏码失败                                      | OnScreenCastResult() 
|
