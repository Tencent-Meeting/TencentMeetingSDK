...
| kTMSDKErrorJoinMeetingServiceFailed                 | -1022  | 非客户端原因被服务端拒绝入会，可能是频繁入会请求、输入无效会议号、会议已结束、入会成员超上限等情况，请用返回错误码和错误描述联系官方 | onJoinMeeting()                                              |
...
| kTMSDKErrorUserJoiningMeeting                          | -1078  | 用户正在入会                            | onJoinMeeting()                                              |
| kTMSDKErrorUserInVoicePrintRecording                 | -1079  | 用户正在录制声纹，限制入会                            | onJoinMeeting()                                              |
| kTMSDKErrorVoicePrintNotCollected                     | -1080  | 当前用户未录入声纹，无法删除声纹          | deleteVoicePrint()                                           |                                        
| kTMSDKErrorNotSupportShowVoicePrintView              | -1081  | 当前用户已录入声纹，无法呼出声纹录入页面          | showVoicePrintRecordView()                                           |      
...
| kTMSDKErrorSetUserConfigFailed                      | -6001  | 用户配置设置失败                                             | setUserConfiguration()                                        |
| kTMSDKErrorSetUserConfigBlePermission               | -6002  | 无蓝牙权限，无法设置用户配置                                 | setUserConfiguration()                                        |
| kTMSDKErrorGetUserConfigFailed                      | -6501  | 用户配置获取失败                                             | getUserConfiguration()                                        |
| kTMSDKErrorAudioDeviceFailed                        | -7001  | 会中音频设备异常                                             | onSDKError()                                                 |
