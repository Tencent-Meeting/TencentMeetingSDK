...
| kTMSDKErrorOpenQRCodeUrlNotInWhiteList |-1061| 当前Url不在白名单内 |onOpenQRCodeUrlResult()|
| kTMSDKErrorOpenQRCodeUrlInMeeing |-1062| 当前在会中，不能打开扫码Url |onOpenQRCodeUrlResult()|
