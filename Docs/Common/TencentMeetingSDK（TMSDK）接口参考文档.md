...
| kTMSDKErrorInvalidJsonString|-1024| 无效的json字符串，请用返回错误码和错误描述联系官方 | onJoinMeeting()、onSetProxyResult()|
| kTMSDKErrorProxySetFailed|-1025| 代理设置失败，请用返回错误码和错误描述联系官方 | onSetProxyResult()|
