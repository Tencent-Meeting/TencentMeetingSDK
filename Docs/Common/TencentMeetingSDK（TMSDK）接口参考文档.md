- [文档修订记录](#------)
- [1. SDK使用说明](#1-sdk----)
  * [1.1 获取SDK实例方法](#11---sdk----)
  * [1.2 获取Service方法](#12---service--)
  * [1.3 SDK基本调用快速入门](#13-sdk--------)
- [2. TMSDK 说明](#2-tmsdk---)
  * [2.1 TMSDK 成员函数](#21-tmsdk-----)
  ...
  * [2.2 SDKCallback 回调代理](#22-sdkcallback-----)
...
- [3. AccountService 说明](#3-accountservice---)
  * [3.1 AccountService 成员函数](#31-accountservice-----)
  ...
  * [3.2 AuthenticationCallback 回调代理](#32-authenticationcallback-----)
    + [onLogin](#onlogin)
    + [onLogout](#onlogout)
    + [onJumpUrlWithLoginStatus](#onjumpurlwithloginstatus)
- [4. PreMeetingService 说明](#4-premeetingservice---)
  * [4.1 PreMeetingService 成员函数](#41-premeetingservice-----)
    ...
    + [showMeetingDetailView【即将移除】](#showmeetingdetailview------)
  ...
  * [4.2 PreMeetingCallback 回调代理](#42-premeetingcallback-----)
    + [onJoinMeeting](#onjoinmeeting)
    + [onShowScreenCastViewResult【即将移除】](#onshowscreencastviewresult------)
    + [onActionResult](#onactionresult)
    + [onShowAddressBook](#onshowaddressbook)
- [5. InMeetingService 说明](#5-inmeetingservice---)
  * [5.1 InMeetingService 成员函数](#51-inmeetingservice-----)
  ...
  * [5.2 InMeetingCallback 回调代理](#52-inmeetingcallback-----)
...
| 2023-02-22 | 3.12.1 | 新增接口：新增反初始化(uninitialize)接口，本地录制相关接口，解析入会短链接接口，收集日志文件的接口 |
